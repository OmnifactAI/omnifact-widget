...
export class ChatBubble extends HTMLElement {
  ...
  set isOpen(value: boolean) {
    this._isOpen = value;
    const chatIcon = this.shadowRoot?.querySelector('.chat-icon') as HTMLElement | null;
    const closeIcon = this.shadowRoot?.querySelector('.close-icon') as HTMLElement | null;
